...
export default function FaqDetailed({ isOpen, onClose }) {
    ...
    const faqList = faq.map((item, index) => {
        return (
            <div className={`flex flex-col justify-start items-left w-full pb-[10px] ${index === (faq.length - 1) ? "" : "border-b border-con-100"}`}>
    ...
    return ReactDOM.createPortal(
        <div className="fixed inset-0 bg-black bg-opacity-[0.35] flex justify-center items-center z-50">
            <div className="p-1 bg-con-200 rounded-[10px] border-[3px] border-con-900 relative max-w-[480px] sm:w-[480px] md:w-[480px] lg:w-[480px] mx-[15px]">
